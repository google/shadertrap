...
CommandSetTextureParameter::CommandSetTextureParameter(
    std::unique_ptr<Token> start_token,
    std::unique_ptr<Token> texture_identifier, TextureParameter parameter,
...
bool CommandSetTextureParameter::Accept(CommandVisitor* visitor) {
  return visitor->VisitSetTextureParameter(this);
}
